...
1. Clone the repository [generation-java-exceptions](https://github.com/alanbrunoscience/generation-java-exceptions) inside your Eclipse/STS *Workspace* folder:

```bash
git clone git@github.com:alanbrunoscience/generation-java-exceptions.git
```
